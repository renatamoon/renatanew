...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora da Renata')
        ...
        #limpando o texto do display caso apertem o botao C
        ...
        # essa funcoa abaixo a funcao "quando clicada, ela tem que adicionar
        # o texto digitado e concatena com o texto

    def add_btn(self, btn, row, col, rowspan, colspan, funcao=None, style=None):  #adiciona botões, colunas, linhas
        ...
        btn.display.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)

    def eval_igual(self):  #fazendo o calculo e setando o equal to na tela
        try:
